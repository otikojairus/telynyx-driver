...
export const config = {
  ...
  baltoStartEventTypes: process.env.BALTO_START_EVENT_TYPES ?? "call.answered,call.bridged",
  baltoStopEventTypes: process.env.BALTO_STOP_EVENT_TYPES ?? "call.hangup,call.ended",
